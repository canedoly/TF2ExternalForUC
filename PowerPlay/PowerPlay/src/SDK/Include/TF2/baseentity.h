...
public:
	...
	EClassIds GetClassId() {
		return static_cast<EClassIds>(g_Memory.RPM<int>(g_Memory.RPM<int>(g_Memory.RPM<int>(g_Memory.RPM<int>(reinterpret_cast<DWORD>(this) + 0x8) + 0x8) + 0x1) + 0x14));
	}

	bool IsDormant() {
		return g_Memory.RPM<bool>(reinterpret_cast<DWORD>(this) + 0x1AA);
	}
